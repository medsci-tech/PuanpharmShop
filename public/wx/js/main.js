...
(function ($) {
    ...
    function Application() {
        var Main = {
            ...
            _initAddressActions: function () {
                ...
                $('.express').on('click', function () {
                    if ($(this).find('.address.on').length) {
                        window.location.href = '/wx/select-address';
                        return false;
                    }
                    showMaskLayer(true);
                    //showWindow($window, true);
                    window.location.href = '/wx/address/pay-create';
                })
            },
            ...
            //
            //
            //        var html = '<a class="product" id="product-' + data.id + '"' + 'href="/member/detail?id=' + data.id + '">';
            ...
            _initOrderDetailActions: function () {
                $('.orderDetail').on('click', function () {
                    var $orderItem = $(this).parents('.order-item');
                    var id = $orderItem.data('order_id');
                    window.location.href = '/wx/order/detail?order_id=' + id;
                    return false;
                })
            },
